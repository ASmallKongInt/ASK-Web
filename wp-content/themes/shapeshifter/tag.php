...
<main id="main-content" class="main-content">
	...
	<?php } else { ?>
		<h3 class="not-found-message"><i class="fa fa-info"></i><?php esc_html_e( 'No Articles.', 'shapeshifter' ); ?></h3><p><?php esc_html_e( 'Please try to search for the page with keywords.', 'shapeshifter' ); ?></p>
		<?php get_search_form(); ?>
	<?php } ?>
</main>
