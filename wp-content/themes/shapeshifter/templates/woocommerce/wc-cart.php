<?php
# Action Hook "shapeshifter_woocommerce_cart"
# Filter Hook "shapeshifter_filters_wc_cart"
...
echo '<main id="main-content" class="main-content">';
	echo '<article '; post_class( 'h-entry' ); echo '>';
		...
		if ( have_posts() ) { while( have_posts() ) { the_post(); global $post;
			...
			echo '<div class="e-content entry-content shapeshifter-content shapeshifter-wc-cart">';
